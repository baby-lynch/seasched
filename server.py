...
class Server:
    ...
    def service(self, req: Request):
        ...
        req.finish_moment = req.sched_moment + req.service_time

        with open('logs/server.log', 'a', encoding='utf-8') as f:
            f.write(('Request{} (cost={}, priority={}) arrive at:{}, scheduled by server at:{}, finishes at:{} , RT:{}, ST:{}\n'.format(
                req.id, req.cost, req.priority, req.arrive_moment, req.sched_moment, req.finish_moment, req.response_time, req.service_time))
            )
